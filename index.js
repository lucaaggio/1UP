(window.Platform = window.Platform || {}),
      ...
      (Path.prototype = createObject({
        ...
        compiledGetValueFromFn: function () {
          var a = "",
            b = "obj";
          a += "if (obj != null";
          for (var c, d = 0; d < this.length - 1; d++)
            (c = this[d]),
              (b += isIdent(c) ? "." + c : formatAccessor(c)),
              (a += " &&\n     " + b + " != null");
          a += ")\n";
          var c = this[d];
          return (
        ...
        check_: function (a, b) {
          ...
          return (
            ...
            b || areSameValue(this.value_, c)
              ? !1
              : (this.report_([this.value_, c, this]), !0)
          );
        },
        setValue: function (a) {
  ...
  Platform.flags.shadow
    ? ((window.ShadowDOMPolyfill = {}),
      (function (a) {
          ...
          for (var e = L(b), f = 0; f < e.length; f++) {
            ...
            if (
              ...
              if (d && "function" == typeof j.value) c[g] = o(g);
                ...
                var l = k(g);
                (h = l ? a.getEventHandlerGetter(g) : m(g)),
                  (j.writable || j.set) &&
                    (i = l ? a.getEventHandlerSetter(g) : n(g)),
                  K(c, g, {
                    get: h,
                    set: i,
        ...
        function w(a) {
          return (
            a instanceof I.EventTarget ||
            a instanceof I.Event ||
            a instanceof I.Range ||
            a instanceof I.DOMImplementation ||
            a instanceof I.CanvasRenderingContext2D ||
            (I.WebGLRenderingContext && a instanceof I.WebGLRenderingContext)
          );
        }
        function x(a) {
          return (
        ...
        function y(a) {
          return null === a
            ? null
            : (c(x(a)),
              a.polymerWrapper_ || (a.polymerWrapper_ = new (h(a))(a)));
        }
        function z(a) {
        ...
        function C(a, b) {
          null !== b &&
            (c(x(a)), c(void 0 === b || w(b)), (a.polymerWrapper_ = b));
        }
        function D(a, b, c) {
        ...
        var G = new WeakMap(),
          ...
          N = { value: void 0, configurable: !0, enumerable: !1, writable: !0 };
        L(window);
        var O = /Firefox/.test(navigator.userAgent),
          ...
          Z = { get: void 0, configurable: !0, enumerable: !0 };
        (a.assert = c),
          (a.constructorTable = G),
          (a.defineGetter = D),
          (a.defineWrapGetter = E),
          (a.forwardMethodsToWrapper = F),
          (a.isWrapper = w),
          (a.isWrapperFor = t),
          (a.mixin = d),
          (a.nativePrototypeTable = H),
          (a.oneOf = f),
          (a.registerObject = u),
          (a.registerWrapper = r),
          (a.rewrap = C),
      ...
      (function (a) {
        ...
        function d(c) {
          if ((c instanceof a.wrappers.Window, c.treeScope_))
            return c.treeScope_;
          var e,
            f = c.parentNode;
      ...
      (function (a) {
        ...
        function h(a, b) {
          ...
          for (
            var c = L(b), d = a[0], e = L(d), f = j(c, e), g = 0;
            g < a.length;
            g++
          ) {
            var h = a[g];
        ...
        function n(b, c) {
          ...
          if ("load" === h && !b.bubbles) {
            var i = c;
            i instanceof Q.Document &&
              (g = i.defaultView) &&
              ((f = i), (e = []));
          }
          if (!e)
            if (c instanceof Q.Window) (g = c), (e = []);
            else if (((e = d(c, b)), "load" !== b.type)) {
              var i = e[e.length - 1];
              i instanceof Q.Document && (g = i.defaultView);
            }
          return (
            _.set(b, e),
            o(b, e, g, f) && p(b, e, g, f) && q(b, e, g, f),
            X.set(b, ab),
            V.delete(b, null),
            T.delete(b),
            b.defaultPrevented
        ...
        function r(a, b, c, d, e) {
          ...
          for (var p = 0, q = f.length; q > p; p++) {
            ...
            if (r.removed) o = !0;
              ...
              try {
                if (
                  ("function" == typeof r.handler
                    ? r.handler.call(a, b)
                    : r.handler.handleEvent(b),
                  Z.get(b))
                )
                  return !1;
              } catch (s) {
        ...
        function t(a, b) {
          ...
          var c = a;
          return pb || "beforeunload" !== c.type
            ? void (this.impl = c)
            : new y(c);
        }
        function u(a) {
          return a && a.relatedTarget
            ? Object.create(a, { relatedTarget: { value: O(a.relatedTarget) } })
            : a;
        }
        function v(a, b, c) {
          var d = window[a],
        ...
        function E(a, b) {
          for (var c = O(a); c; c = c.parentNode) if (D(P(c), b)) return !0;
          return !1;
        }
        function F(a) {
          K(a, rb);
        ...
        var eb = window.Event;
        (eb.prototype.polymerBlackList_ = { returnValue: !0, keyLocation: !0 }),
          (t.prototype = {
            get target() {
              return U.get(this);
            },
        ...
        var fb = v("UIEvent", t),
          ...
          ib = M({ initMouseEvent: w("initMouseEvent", 14) }, hb),
          jb = M({ initFocusEvent: w("initFocusEvent", 5) }, hb),
        ...
        if (!nb) {
          ...
          ob("Event", { bubbles: !1, cancelable: !1 }),
            ob("CustomEvent", { detail: null }, "Event"),
            ob("UIEvent", { view: null, detail: 0 }, "Event"),
            ob(
              "MouseEvent",
              {
                screenX: 0,
            ...
            ob("FocusEvent", { relatedTarget: null }, "UIEvent");
        }
        ...
        (a.elementFromPoint = G),
          (a.getEventHandlerGetter = H),
          (a.getEventHandlerSetter = I),
          (a.wrapEventTargetMethods = F),
          (a.wrappers.BeforeUnloadEvent = y),
          (a.wrappers.CustomEvent = gb),
          (a.wrappers.Event = t),
          (a.wrappers.EventTarget = B),
          (a.wrappers.FocusEvent = lb),
          (a.wrappers.MouseEvent = kb),
          (a.wrappers.UIEvent = fb);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        function b(a, b) {
        ...
        if (l) {
          ...
          var p = { configurable: !0, enumerable: !0, get: null };
          [
            "clientX",
            "clientY",
            "screenX",
            ...
            i(l, f, m),
            (a.wrappers.Touch = c),
            (a.wrappers.TouchEvent = f),
            (a.wrappers.TouchList = d);
        }
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
      ...
      (function (a) {
        ...
        (d.prototype = Object.create(g.prototype)),
          ...
          p.prototype.webkitCreateShadowRoot &&
            (d.prototype.webkitCreateShadowRoot = d.prototype.createShadowRoot),
          l(d.prototype, e),
          l(d.prototype, f),
          l(d.prototype, i),
          l(d.prototype, j),
          m(p, d, document.createElementNS(null, "x")),
          (a.invalidateRendererBasedOnAttribute = b),
          (a.matchesNames = q),
      ...
      (function (a) {
        ...
        (b.prototype = Object.create(c.prototype)),
          ...
          e(h, b, document.createElement("form")),
          (a.wrappers.HTMLFormElement = b);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        function b(a) {
      ...
      (function (a) {
        ...
        if (!("classList" in f)) {
          ...
          Object.defineProperty(c.prototype, "classList", i),
            delete b.prototype.classList;
        }
      ...
      (function (a) {
        ...
        function b(a) {
          ...
          var e = a.shadowRoot;
          m.set(this, e),
            (this.treeScope_ = new d(this, g(e || a))),
            l.set(this, a);
        }
      ...
      (function (a) {
        ...
        function o(a) {
          for (var b = [], c = a.firstChild; c; c = c.nextSibling)
            v(c) ? b.push.apply(b, f(c)) : b.push(c);
          return b;
        }
        function p(a) {
          ...
          (n.prototype = {
            ...
            invalidate: function () {
              if (!this.dirty) {
                ...
                if ((a && a.invalidate(), M.push(this), y)) return;
                y = window[L](i, 0);
              }
            },
            ...
            resetAll: function (a) {
              ...
              a.shadowRoot && this.resetAll(a.shadowRoot),
                a.olderShadowRoot && this.resetAll(a.olderShadowRoot);
            },
            distributionResolution: function (a) {
              if (w(a)) {
                for (var b = a, c = o(b), d = x(b), e = 0; e < d.length; e++)
                  this.poolDistribution(d[e], c);
              ...
              for (var j = a.firstChild; j; j = j.nextSibling)
                this.distributionResolution(j);
            },
            ...
            compose: function (a) {
              for (
                var b = [], c = a.shadowRoot || a, d = c.firstChild;
                d;
                d = d.nextSibling
              )
                if (v(d)) {
        ...
        (C.prototype.invalidateShadowRenderer = function () {
          ...
          (A.prototype.getDistributedNodes = B.prototype.getDistributedNodes =
            function () {
              return h(), f(this);
            }),
          ...
          (A.prototype.nodeIsInserted_ = B.prototype.nodeIsInserted_ =
            function () {
              this.invalidateShadowRenderer();
              var a,
                b = k(this);
          ...
          (a.getRendererForHost = j),
          (a.getShadowTrees = x),
          (a.renderAllPending = h),
          (a.getDestinationInsertionPoints = r),
        ...
        if (
          (v(b.prototype, {
            ...
            getElementsByName: function (a) {
              return n.querySelectorAll.call(
                this,
                "[name=" + JSON.stringify(String(a)) + "]"
              );
            },
          }),
      ...
      (function (a) {
        "use strict";
        function b(a) {
          this.impl = new e(a && d(a));
        }
        var c = a.registerWrapper,
          d = a.unwrap,
          e = window.FormData;
        c(e, b, new e()), (a.wrappers.FormData = b);
      })(window.ShadowDOMPolyfill),
      (function (a) {
        "use strict";
        function b(a) {
      ...
      (function (a) {
        function b(a, c) {
          ...
          for (e = [], f = a.shadowRoot; f; )
            e.push(f), (f = f.olderShadowRoot);
        ...
        function c(a, b, d) {
          var e,
            ...
            h,
            i,
            j = a.firstElementChild;
          for (g = [], f = a.shadowRoot; f; )
            g.push(f), (f = f.olderShadowRoot);
          for (h = g.length - 1; h >= 0; h--)
            for (e = g[h].querySelectorAll(b), i = 0; i < e.length; i++)
              d.push(e[i]);
        ...
        (Element.prototype.createShadowRoot = function () {
          ...
          (a.queryAllShadows = function (a, d, e) {
        ...
        var k = {
            ...
            scopeCssText: function (a, b) {
              ...
              if (
                ...
                (a = this.convertShadowDOMSelectors(a)),
                b)
              ) {
                var a,
                  d = this;
            ...
            convertShadowDOMSelectors: function (a) {
              for (var b = 0; b < shadowDOMSelectorsRe.length; b++)
                a = a.replace(shadowDOMSelectorsRe[b], " ");
              return a;
            },
                ...
                a &&
                  Array.prototype.forEach.call(
                    ...
                    function (a) {
                      ...
                      else if (a.type === CSSRule.MEDIA_RULE)
  ...
  (function (a) {
    ...
    function e(a, b) {
      for (
        var c = a.pathname, d = b.pathname, e = c.split("/"), f = d.split("/");
        e.length && e[0] === f[0];
        ...
        resolveElementAttributes: function (a, d) {
          (d = d || a.ownerDocument.baseURI),
            i.forEach(function (e) {
              ...
              i &&
                i.search(k) < 0 &&
                ((f = "style" === e ? b(i, d, !1, g) : c(d, i)), (h.value = f));
            });
        },
      },
      g = /(url\()([^)]*)(\))/g,
  ...
  (function (a) {
    ...
    (d.prototype = {
      ...
      receive: function (a, b, c, d, e) {
        ...
        for (var g, h = 0, i = f.length; i > h && (g = f[h]); h++)
          this.onload(e || a, g, d), this.tail();
  ...
  (function (a) {
    ...
    function c(a) {
      ...
      try {
        ...
        c += ";charset=utf-8," + encodeURIComponent(b);
      }
      return c;
    }
    function d(a) {
    ...
    var g = "import",
      ...
      k = {
        ...
        invalidateParse: function (a) {
          a &&
            a.__importLink &&
            ((a.__importParsed = a.__importLink.__importParsed = !1),
            this.parseSoon());
        },
        parseSoon: function () {
  ...
  (function (a) {
    ...
    function d(a, b) {
      ...
      c instanceof Document ||
        (c = document.implementation.createHTMLDocument(q)),
        (c._URL = b);
    ...
    function g(a, b) {
      if (f(b)) a && a();
        ...
        var c = function () {
          ("complete" === b.readyState || b.readyState === y) &&
            (b.removeEventListener(z, c), g(a, b));
        };
    ...
    function i(a) {
      return o
        ? (a.import && "loading" !== a.import.readyState) || a.__loaded
        : a.__importParsed;
    }
    function j(a) {
    ...
    var n = "import" in document.createElement("link"),
      ...
      p = a.flags,
      q = "import",
      r = window.ShadowDOMPolyfill
        ? ShadowDOMPolyfill.wrapIfNeeded(document)
        : document;
    if (o) var s = {};
    else
      var t = (a.xhr, a.Loader),
        u = a.parser,
        s = {
          documents: {},
          ...
          loaded: function (a, c, e) {
            if (
              (p.load && console.log("loaded", a, c), (c.__resource = e), b(c))
            ) {
    ...
    if (
      (Object.defineProperty(document, "_currentScript", w),
      Object.defineProperty(r, "_currentScript", w),
      !document.baseURI)
    ) {
      var x = {
        get: function () {
      ...
      Object.defineProperty(document, "baseURI", x),
        Object.defineProperty(r, "baseURI", x);
    }
    ...
    o &&
      new MutationObserver(function (a) {
        for (var b, c = 0, d = a.length; d > c && (b = a[c]); c++)
          b.addedNodes && j(b.addedNodes);
      }).observe(document.head, { childList: !0 }),
      (a.hasNative = n),
      (a.useNative = o),
      (a.importer = s),
      (a.IMPORT_LINK_TYPE = q),
      (a.isImportLoaded = i),
      (a.importLoader = v),
      (a.whenReady = e),
  ...
  (function (a) {
    ...
    function c(a) {
      for (var b, e, g = 0, h = a.length; h > g && (e = a[g]); g++)
        (b = b || e.ownerDocument),
          d(e) && f.loadNode(e),
          e.children && e.children.length && c(e.children);
    }
    function d(a) {
  ...
  (function (a) {
    ...
    function f(a) {
      if (!Object.__proto__) {
        ...
        for (var e, f = a.prototype; f && f !== b; )
          (e = Object.getPrototypeOf(f)), (f.__proto__ = e), (f = e);
        a.native = b;
      }
    }
    function g(a) {
    ...
    (b.prototype = {
      ...
      fetch: function (a, b) {
        ...
        for (
          ...
          (d = a[h]),
            (f = d.url),
            (e = this.cache[f]),
            e || ((e = this.xhr(f)), (e.match = d), (this.cache[f] = e)),
            e.wait(g);
      },
      ...
      xhr: function (a) {
        ...
        return (
          b.open("GET", a, !0),
          b.send(),
          (b.onerror = b.onload = this.handleXhr.bind(this, b)),
          (b.pending = []),
          (b.resolve = function () {
  ...
  (function (a) {
    ...
    b.prototype = {
      ...
      loadStyles: function (a, b, c) {
        ...
        for (var e, f = 0, g = a.length, h = 0; g > h && (e = a[h]); h++)
          this.resolveNode(e, b, d);
      },
    };
    var e = new b();
    a.styleResolver = e;
